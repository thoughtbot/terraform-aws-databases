module "secret" {
  source = "github.com/thoughtbot/terraform-aws-secrets//secret?ref=em-provider-aws-v5"
...
module "rotation" {
  source = "github.com/thoughtbot/terraform-aws-secrets//secret-rotation-function?ref=em-provider-aws-v5"
