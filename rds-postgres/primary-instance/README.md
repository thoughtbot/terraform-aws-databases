...
| <a name="input_create_security_group"></a> [create\_security\_group](#input\_create\_security\_group) | Set to false to only use existing security groups | `bool` | `true` | no |
...
| <a name="input_vpc_security_group_ids"></a> [vpc\_security\_group\_ids](#input\_vpc\_security\_group\_ids) | IDs of VPC security groups for this instance. One of vpc\_id or vpc\_security\_group\_ids is required | `list(string)` | `[]` | no |
